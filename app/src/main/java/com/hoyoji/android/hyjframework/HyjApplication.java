...
public class HyjApplication extends Application {
	...
	public static String getServerUrl() {
		if(mIsDebuggable){
			return "http://foodtoday.duapp.com/";
		} else {
			return "http://foodtodaytest.duapp.com/";
		}
	}
...
//        });
	...
	public void initContentProvider(){
		...
		ContentProviderClient client = resolver.acquireContentProviderClient("com.hoyoji.foodtoday_android");
